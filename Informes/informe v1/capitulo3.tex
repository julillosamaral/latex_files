...
<<<<<<< HEAD
	...
	Si bien la información correlacionada es de utilidad para los analistas debido a que facilita el analisis de la información. Es necesario contar con toda la
	información recibida para poder hacer un análisis de los datos originales por parte de los analistas en caso de que sea necesario.
=======
...
>>>>>>> 5111f256a21908c8b4e19f527eb76ed1d6cdef31
...
<<<<<<< HEAD
	en el sistema un servicio TAXII, con dichos servicios se realizara el intercambio de información con otra organización.
=======
