...
\subparagraph{Feed Information Exchange}\ \\
...
El cliente consumidor inicia el 
El backend TAXII evalua el pedido de información información para determinar la respuesta. La respuesta retorna mensajes STIX con el contenido que pidió el cliente.
