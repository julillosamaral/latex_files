...
Durante el proyecto se realizó una investigación profunda referente al intercambio de información entre organizaciones. De dicha investigación surgieron los requerimientos buscados en una herramienta que intercambie información de seguridad entre organizaciones. Si bien existen algunos esfuerzos previos para realizar el intercambio de información, ninguno permite el intercambio de información con las caracteristicas con las que cuentan STIX y TAXII.

Se ideó una herramienta que permite a las organizaciones intercambiar información de seguridad. Se buscó que el desarrollo realizado se integre con RTIR debido a que es una herramienta importante en la operativa de los CSIRTs. Como resultado de dicha integración se le provee a RTIR de una representación estructurada de la información. A su vez se le da la posibilidad a esta herramienta de intercambiar dicha información con otras organizaciones siempre y cuando estas utilicen el protocolo TAXII.
