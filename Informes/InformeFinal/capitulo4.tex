...
\label{capitulo4}
	...
	{\centering
		\foreignlanguage{spanish}{FiguraCap4 }\stepcounter{FiguraCap4}{\theFigura}\foreignlanguage{spanish}{ - Arquitectura del sistema}
		\par}
	...
	{\centering
		\foreignlanguage{spanish}{FiguraCap4 }\stepcounter{FiguraCap4}{\theFigura}\foreignlanguage{spanish}{ - Diagrama de datos}
		\par}
