...
\hline
\centering\arraybslash{\selectlanguage{spanish}\bfseries Requerimientos funcionales}\\\hline
\begin{itemize}
...
\begin{supertabular}{|m{5.83516in}|}
\hline
\centering\arraybslash{\selectlanguage{spanish}\bfseries Requerimientos no funcionales}\\\hline
\begin{itemize}
...
\end{center}
{\centering\selectlanguage{english}\bfseries
\foreignlanguage{spanish}{Figura }\stepcounter{Figura}{\theFigura}\foreignlanguage{spanish}{ - \ Caso de uso borrado
...
{\centering\selectlanguage{english}\bfseries
\foreignlanguage{spanish}{Figura }\stepcounter{Figura}{\theFigura}\foreignlanguage{spanish}{ - Caso de uso borrar
servicio TAXII}
\par}
\end{center}
{\selectlanguage{spanish}
...
{\centering\selectlanguage{english}\bfseries
\foreignlanguage{spanish}{Figura }\stepcounter{Figura}{\theFigura}\foreignlanguage{spanish}{ - \ Caso de uso modificar
servicio TAXII}
\par}
\end{center}
...
}}\stepcounter{Figura}{\theFigura}\foreignlanguage{spanish}{\textbf{ -
